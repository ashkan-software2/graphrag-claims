...
# Goal
Given a text document and its extracted entitites, entity types, and relationships, write a comprehensive assessment report of a community taking on the role of a {role}.
...
-----------
Text:
Some text here about entities and relationships related to verdant oasis plaza, harmony assembly, unity march, and tribune spotlight.
...
Use the following text and the extracted entitites and relationships for your answer. Do not make anything up in your answer.
...
COMMUNITY_REPORT_SUMMARIZATION_PROMPT_OLD = """
{persona}
